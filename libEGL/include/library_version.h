...
// libegl3: Cabecalho para configuracao automatica das bibliotecas no Visual Studio
   ...
   // this is Visual C++ 2010
	...
	#include "SDL_Collide.h"
	...
	#ifndef _DEBUG
		#pragma message("RELEASE: added libs: sdl.lib sdlmain.lib sdl_image.lib (VS2010+)")
		...
		#pragma comment(lib, "..//egl3//lib//NET2010//libegl.lib")
	#else
		#pragma message("DEBUG: added libs: sdl.lib sdlmain.lib sdl_image.lib (VS2010+)")
		#pragma comment(lib, "..//egl3//SDL//lib//sdl.lib")
		#pragma comment(lib, "..//egl3//SDL//lib//sdlmain.lib")
		#pragma comment(lib, "..//egl3//SDL//lib//sdl_image.lib")
		#pragma comment(lib, "..//egl3//SDL//lib//sdl_ttf.lib")
		#pragma comment(lib, "..//egl3//SDL//lib//sdl_gfx.lib")
		#pragma comment(lib, "..//egl3//SDL//lib//sdl_mixer.lib")
		#pragma comment(lib, "..//egl3//lib//NET2010//libegl_d.lib")
	#endif	
#else
#if _MSC_VER >= 1500
